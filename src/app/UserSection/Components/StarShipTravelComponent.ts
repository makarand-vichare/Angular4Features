...
@Component({
  ...
  styleUrls: ['./../Views/StarShipTravelComponent.scss'],
  providers: [PlanetService, StarShipTravelService , NGXLogger]
})

export class StarShipTravelComponent extends BaseComponent implements OnInit {
  constructor(private modalService: NgbModal, _routerService: Router, _logService: NGXLogger, private planetService: PlanetService,
